<template>
  <view class="paySuccess">
    ...
    <view class="footer-btn">
      ...
      <view class="two" @click="anewOpen">重新开门</view>
  ...
  .top-bgc {
    ...
    .top-content {
      ...
      .icon {
        ...
        box-shadow: 0rpx 9rpx 6rpx rgba(254, 124, 124, 0.14);
        border-radius: 50%;
        view {
          font-size: 104rpx;
          color: #fa826d;
